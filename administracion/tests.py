...
class TrabajadorTest(TestCase):
    ...
    def test_creacion_trabajador_mommy(self):
        ...
        self.assertEqual(self.t3.__str__(), self.t3.apellido_paterno+' '+self.t3.apellido_materno +' '+ self.t3.nombres)     
    ...
    def test_nombre_completo(self):
        self.assertEqual(self.t3.nombre_completo(),self.t3.nombres +' '+ self.t3.apellido_paterno+' '+self.t3.apellido_materno)
        p = mommy.make(Profesion)
        t = mommy.make(Trabajador,profesion=p)
        self.assertEqual(t.nombre_completo(),t.profesion.abreviatura+' '+t.nombres +' '+ t.apellido_paterno+' '+t.apellido_materno)
